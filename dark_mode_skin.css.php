.column-left .v-card {padding: 1px}

#search-page-container sbx-pop-out {
display:none;
}

:root {
            --navigation-foreground-r: 30;
        --navigation-foreground-g: 30;
        --navigation-foreground-b: 30;
        --navigation-foreground-h: 0;
        --navigation-foreground-s: 90%;
        --navigation-foreground-l: 190%;
        ...
        --navigation-foreground-contrast-s: 90%;
        --navigation-foreground-contrast-l: 90%;
        ...
        --navigation-background-g: 46;
        --navigation-background-b: 108;
        --navigation-background-h: 214.44;
        --navigation-background-s: 190%;
        --navigation-background-l: 21.18%;
        ...
        --navigation-background:   hsla(
            ...
            --navigation-background-contrast-r: 30;
        --navigation-background-contrast-g: 30;
        --navigation-background-contrast-b: 30;
        --navigation-background-contrast-h: 0;
        --navigation-background-contrast-s: 90%;
        --navigation-background-contrast-l: 190%;
        ...
        --navigation-hover-g: 137;
        --navigation-hover-b: 149;
        --navigation-hover-h: 184.83;
        --navigation-hover-s: 190%;
        --navigation-hover-l: 29.22%;
        ...
        --navigation-hover:   hsla(
            ...
            --navigation-hover-contrast-r: 30;
        --navigation-hover-contrast-g: 30;
        --navigation-hover-contrast-b: 30;
        --navigation-hover-contrast-h: 0;
        --navigation-hover-contrast-s: 90%;
        --navigation-hover-contrast-l: 190%;
        ...
        --off-canvas-foreground-g: 46;
        --off-canvas-foreground-b: 108;
        --off-canvas-foreground-h: 214.44;
        --off-canvas-foreground-s: 190%;
        --off-canvas-foreground-l: 21.18%;
        ...
        --off-canvas-foreground:   hsla(
            ...
            --off-canvas-foreground-contrast-r: 30;
        --off-canvas-foreground-contrast-g: 30;
        --off-canvas-foreground-contrast-b: 30;
        --off-canvas-foreground-contrast-h: 0;
        --off-canvas-foreground-contrast-s: 90%;
        --off-canvas-foreground-contrast-l: 190%;
        ...
        --off-canvas-foreground-contrast:   hsla(
            ...
            --off-canvas-background-r: 30;
        --off-canvas-background-g: 30;
        --off-canvas-background-b: 30;
        --off-canvas-background-h: 0;
        --off-canvas-background-s: 90%;
        --off-canvas-background-l: 190%;
        ...
        --off-canvas-background-contrast-s: 90%;
        --off-canvas-background-contrast-l: 90%;
        ...
        --off-canvas-hover-g: 137;
        --off-canvas-hover-b: 149;
        --off-canvas-hover-h: 184.83;
        --off-canvas-hover-s: 190%;
        --off-canvas-hover-l: 29.22%;
        --off-canvas-hover-a: 0.77;
        --off-canvas-hover:   hsla(
            ...
            --off-canvas-hover-contrast-r: 30;
        --off-canvas-hover-contrast-g: 30;
        --off-canvas-hover-contrast-b: 30;
        --off-canvas-hover-contrast-h: 0;
        --off-canvas-hover-contrast-s: 90%;
        --off-canvas-hover-contrast-l: 190%;
        ...
        --accounts-menu-foreground-g: 46;
        --accounts-menu-foreground-b: 108;
        --accounts-menu-foreground-h: 214.44;
        --accounts-menu-foreground-s: 190%;
        --accounts-menu-foreground-l: 21.18%;
        ...
        --accounts-menu-foreground:   hsla(
            ...
            --accounts-menu-foreground-contrast-r: 30;
        --accounts-menu-foreground-contrast-g: 30;
        --accounts-menu-foreground-contrast-b: 30;
        --accounts-menu-foreground-contrast-h: 0;
        --accounts-menu-foreground-contrast-s: 90%;
        --accounts-menu-foreground-contrast-l: 190%;
        ...
        --accounts-menu-foreground-contrast:   hsla(
            ...
            --accounts-menu-background-r: 233;
        --accounts-menu-background-g: 245;
        --accounts-menu-background-b: 246;
        --accounts-menu-background-h: 184.62;
        --accounts-menu-background-s: 41.94%;
        --accounts-menu-background-l: 93.92%;
        ...
        --accounts-menu-background-contrast-s: 90%;
        --accounts-menu-background-contrast-l: 90%;
        ...
        --accounts-menu-background-contrast:   hsla(
            ...
            --accounts-menu-hover-r: 0;
        --accounts-menu-hover-g: 137;
        --accounts-menu-hover-b: 149;
        --accounts-menu-hover-h: 184.83;
        --accounts-menu-hover-s: 190%;
        --accounts-menu-hover-l: 29.22%;
        --accounts-menu-hover-a: 0.77;
        --accounts-menu-hover:   hsla(
            ...
            --accounts-menu-hover-contrast-r: 30;
        --accounts-menu-hover-contrast-g: 30;
        --accounts-menu-hover-contrast-b: 30;
        --accounts-menu-hover-contrast-h: 0;
        --accounts-menu-hover-contrast-s: 90%;
        --accounts-menu-hover-contrast-l: 190%;
        ...
        --accounts-menu-hover-contrast:   hsla(
            ...
            --content-ui-foreground-r: 1;
        --content-ui-foreground-g: 68;
        --content-ui-foreground-b: 156;
        --content-ui-foreground-h: 214.06;
        --content-ui-foreground-s: 98.73%;
        --content-ui-foreground-l: 30.78%;
        ...
        --content-ui-foreground:   hsla(
            ...
            --content-ui-foreground-contrast-r: 30;
        --content-ui-foreground-contrast-g: 30;
        --content-ui-foreground-contrast-b: 30;
        --content-ui-foreground-contrast-h: 0;
        --content-ui-foreground-contrast-s: 90%;
        --content-ui-foreground-contrast-l: 190%;
        ...
        --content-ui-foreground-contrast:   hsla(
            ...
            --content-ui-background-r: 183;
        --content-ui-background-g: 227;
        --content-ui-background-b: 231;
        --content-ui-background-h: 185;
        --content-ui-background-s: 590%;
        --content-ui-background-l: 81.18%;
        ...
        --content-ui-background-contrast-s: 90%;
        --content-ui-background-contrast-l: 90%;
        ...
        --content-ui-background-contrast:   hsla(
            ...
            --content-ui-hover-r: 202;
        --content-ui-hover-g: 234;
        --content-ui-hover-b: 237;
        --content-ui-hover-h: 185.14;
        --content-ui-hover-s: 49.3%;
        --content-ui-hover-l: 86.08%;
        ...
        --content-ui-hover-contrast-s: 90%;
        --content-ui-hover-contrast-l: 90%;
        ...
        --content-ui-hover-contrast:   hsla(
            ...
            --content-ui-selected-r: 183;
        --content-ui-selected-g: 227;
        --content-ui-selected-b: 231;
        --content-ui-selected-h: 185;
        --content-ui-selected-s: 590%;
        --content-ui-selected-l: 81.18%;
        ...
        --content-ui-selected-contrast-s: 90%;
        --content-ui-selected-contrast-l: 90%;
        ...
        --content-ui-selected-contrast:   hsla(
            ...
            --content-ui-submit-foreground-r: 30;
        --content-ui-submit-foreground-g: 30;
        --content-ui-submit-foreground-b: 30;
        --content-ui-submit-foreground-h: 0;
        --content-ui-submit-foreground-s: 90%;
        --content-ui-submit-foreground-l: 190%;
        ...
        --content-ui-submit-foreground-contrast-s: 90%;
        --content-ui-submit-foreground-contrast-l: 90%;
        ...
        --content-ui-submit-foreground-contrast:   hsla(
            ...
            --content-ui-submit-background-r: 35;
        --content-ui-submit-background-g: 169;
        --content-ui-submit-background-b: 181;
        --content-ui-submit-background-h: 184.93;
        --content-ui-submit-background-s: 67.59%;
        --content-ui-submit-background-l: 42.35%;
        ...
        --content-ui-submit-background:   hsla(
            ...
            --content-ui-submit-background-contrast-r: 30;
        --content-ui-submit-background-contrast-g: 30;
        --content-ui-submit-background-contrast-b: 30;
        --content-ui-submit-background-contrast-h: 0;
        --content-ui-submit-background-contrast-s: 90%;
        --content-ui-submit-background-contrast-l: 190%;
        ...
        --accent-foreground-g: 46;
        --accent-foreground-b: 108;
        --accent-foreground-h: 214.44;
        --accent-foreground-s: 190%;
        --accent-foreground-l: 21.18%;
        ...
        --accent-foreground:   hsla(
            ...
            --accent-foreground-contrast-r: 30;
        --accent-foreground-contrast-g: 30;
        --accent-foreground-contrast-b: 30;
        --accent-foreground-contrast-h: 0;
        --accent-foreground-contrast-s: 90%;
        --accent-foreground-contrast-l: 190%;
        ...
        --accent-foreground-contrast:   hsla(
            ...
            --accent-background-r: 233;
        --accent-background-g: 245;
        --accent-background-b: 246;
        --accent-background-h: 184.62;
        --accent-background-s: 41.94%;
        --accent-background-l: 93.92%;
        ...
        --accent-background-contrast-s: 90%;
        --accent-background-contrast-l: 90%;
        ...
        --accent-hover-b: 244;
        --accent-hover-h: 180;
        --accent-hover-s: 24.14%;
        --accent-hover-l: 94.31%;
        --accent-hover-a: 1;
        --accent-hover:   hsla(
            var(--accent-hover-h),
            var(--accent-hover-s),
        ...
        --accent-hover-contrast-s: 90%;
        --accent-hover-contrast-l: 90%;
        ...
        --accent-hover-contrast:   hsla(
            ...
            --logo-background-r: 30;
        --logo-background-g: 30;
        --logo-background-b: 30;
        --logo-background-h: 0;
        --logo-background-s: 90%;
        --logo-background-l: 190%;
        --logo-background-a: 1;
        ...
        --logo-background-contrast-s: 90%;
        --logo-background-contrast-l: 90%;
        ...
        --body-background-contrast-s: 90%;
        --body-background-contrast-l: 90%;
        ...
        --body-background-contrast:   hsla(
            ...
            --login-form-background-r: 30;
        --login-form-background-g: 30;
        --login-form-background-b: 30;
        --login-form-background-h: 0;
        --login-form-background-s: 90%;
        --login-form-background-l: 190%;
        --login-form-background-a: 0.62;
        ...
        --login-form-background-contrast-s: 90%;
        --login-form-background-contrast-l: 90%;
        ...
        --login-form-background-contrast:   hsla(
            ...
            --form-border-color-r: 183;
        --form-border-color-g: 227;
        --form-border-color-b: 231;
        --form-border-color-h: 185;
        --form-border-color-s: 590%;
        --form-border-color-l: 81.18%;
        ...
        --form-border-color-contrast-s: 90%;
        --form-border-color-contrast-l: 90%;
        ...
        --form-bg-hover-color-b: 30;
        --form-bg-hover-color-h: 204.78;
        --form-bg-hover-color-s: 190%;
        ...
        --form-bg-hover-color-contrast-s: 90%;
        --form-bg-hover-color-contrast-l: 90%;
        ...
        --body-foreground-h1:   hsla(
            ...
            --navigation-foreground-highlight-r: 30;
        --navigation-foreground-highlight-g: 30;
        --navigation-foreground-highlight-b: 30;
        --navigation-foreground-highlight-h: 0;
        --navigation-foreground-highlight-s: 90%;
        --navigation-foreground-highlight-l: 190%;
